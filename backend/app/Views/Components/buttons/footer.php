...
<footer class="footer footer-horizontal footer-center bg-black text-white rounded p-10">
    <nav role="navigation" aria-label="footer-links" class="grid grid-flow-col gap-4 text-white">
    ...
    <nav role="navigation" aria-label="social-links">
        <div class="grid grid-flow-col gap-4 text-white">
            <a class="text-white" aria-label="Twitter">
                <svg
            ...
            <a class="text-white" aria-label="YouTube">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
            ...
            <a class="text-white" aria-label="Facebook">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
...
<script src="https://cdn.tailwindcss.com"></script>
         ...
         <!-- <div class="container mx-auto px-4 py-4 text-center text-gray-400 text-sm">
              &copy;  Vian Tibay Project AD-Project. All rights reserved.
          </div>
           -->
